...
namespace Dio.CatalogoJogos.Test.Services
{
    public class JogoServiceTests
    {
        ...
        private Jogo _testEntity;
        private JogoInputModel _testInputModel;
        ...
        public async Task ObterPorId_ShouldCallRepositoryWithCorrectParameters()
        {
            // Arrange
            var repositoryMock = new Mock<IJogoRepository>();
            repositoryMock.Setup(m => m.Obter(It.IsAny<Guid>()))
        ...
        public async Task Inserir_ShouldCallRepositoryWithCorrectParameters()
        {
            // Arrange
            var repositoryMock = new Mock<IJogoRepository>();
            repositoryMock.Setup(m => m.VerificaConflito(It.IsAny<Jogo>()))
                .ReturnsAsync(false);
        ...
        [Fact]
        public async Task Inserir_ShouldReturnViewModel_IfVerificaConflitoReturnedFalse()
        {
            // Arrange
            var repositoryMock = new Mock<IJogoRepository>();
            repositoryMock.Setup(m => m.VerificaConflito(It.IsAny<Jogo>()))
        ...
        [Fact]
        public async Task Inserir_ShouldThrowEntidadeJaCadastradaException_IfVerificaConflitoReturnedTrue()
        {
            // Arrange
            var repositoryMock = new Mock<IJogoRepository>();
            repositoryMock.Setup(m => m.VerificaConflito(It.IsAny<Jogo>()))
